...
import { Plus, Search as SearchIcon, X, Sparkles, RefreshCw, UserCheck, LogOut, KeyRound, Menu } from 'lucide-react';
...
const App: React.FC = () => {
  ...
  useEffect(() => {
    ...
    localStorage.removeItem('convex_theme');
  }, []);
          ...
          <div className="flex items-center gap-4">
            <div className="relative">
              ...
              <input 
                ...
                className="pl-10 pr-4 py-2 bg-white border border-slate-200 rounded-xl w-64 focus:outline-none focus:ring-2 focus:ring-indigo-500/20 text-sm text-slate-900"
              />
            </div>
